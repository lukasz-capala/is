...
function outputData($result, $root, $group = 'item', $additional = null, $format) {
	$output = Array();
	$i = 0;
	...
	if ($captcha_verify["success"] != false) {
		switch($action) {
			case 'countMachinesByClass':
				...
				outputData($result, 'summary', 'class', $additional, $format);
			break;
			...
			case 'countMachinesByManufacturer':
				...
				outputData($result, 'summary', 'manufacturer', $additional, $format);
			break;
			...
			case 'get10MostExpensive':
				...
				outputData($result, 'summary', 'machine', $additional, $format);
			break;
			...
			case 'getAverageCost':
				...
				outputData($result, 'summary', 'cost_info', null, $format);
			break;
			...
			case 'getLastIssues':
				...
				outputData($result, 'summary', 'issue', $additional, $format);
			break;
			...
			case 'getOwnersAndDescriptions':
				...
				outputData($result, 'summary', 'person', $additional, $format);
			break;
